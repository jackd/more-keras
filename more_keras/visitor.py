...
class ComponentsToRagged(Visitor):
    ...
    def __init__(self):
        super(ComponentsToRagged,
              self).__init__({RaggedComponents: self.visit_ragged_components})
...
class ComponentsToNumpy(ComponentsToRagged):
    ...
    def visit_ragged_components(self, obj):
        ...
        return RaggedArray.from_row_splits(self.visit(obj.flat_values),
                                           self.visit(obj.nested_row_splits[0]))
