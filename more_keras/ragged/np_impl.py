...
class RaggedArray(object):
    ...
    def from_ragged_tensor_value(self, ragged_tensor_value):
        return RaggedArray.from_row_splits(ragged_tensor_value.values,
    ...
    def from_ragged_lists(ragged_lists, dtype=np.float32):
        ...
        return RaggedArray(flat_values,
                           row_lengths,
                           ragged_lists=ragged_lists,
    ...
    def from_row_lengths(values, row_lengths):
        ...
        return RaggedArray(values=values,
    ...
    @staticmethod
    def from_row_splits(values,
                        row_splits,
                        values_dtype=None,
                        splits_dtype=np.int64):
    ...
    def row_lengths(self):
        if self._row_lengths is None:
            if self._ragged_lists is None:
                ...
                self._row_lengths = np.array(tuple(
                    len(l) for l in self._ragged_lists),
                                             dtype=np.int64)
    ...
    def mask(self, boolean_mask):
        ...
        ragged_lists = [r for r, m in zip(self.ragged_lists, boolean_mask) if m]
